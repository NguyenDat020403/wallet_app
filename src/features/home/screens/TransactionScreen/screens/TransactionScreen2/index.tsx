...
import {IconDelete, IconTrade} from '@/assets/icons';
    ...
    <View style={styles.container}>
      <View style={{flexGrow: 1}}>
        ...
        <View
          ...
          <Text
            ...
            style={[
              ...
              {flexShrink: 1, flex: 1, color: '#B0B0B0'},
              {
                color: amount > token.balance ? 'red' : '#FFF',
              },
            ]}>
            {amount}
          </Text>
        ...
        <View
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={{backgroundColor: '#333333', padding: 8, borderRadius: 150}}>
            ...
            return (
              <TouchableOpacity
                ...
                {item === '#' ? (
                  ...
                  <Text style={styles.textBody1Regular}>{item}</Text>
                )}
              </TouchableOpacity>
            );
          }}
